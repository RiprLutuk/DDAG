...
func BuildMySQL(ctx context.Context, cfg PoolConfig) (Connector, error) {
	...
	return newSQLConnector(ctx, cfg, "mysql", dsn, PlaceholderForDialect(DialectMySQL))
}
...
func BuildSQLServer(ctx context.Context, cfg PoolConfig) (Connector, error) {
	...
	return newSQLConnector(ctx, cfg, "sqlserver", u.String(), PlaceholderForDialect(DialectSQLServer))
}
...
func BuildOracle(ctx context.Context, cfg PoolConfig) (Connector, error) {
	...
	return newSQLConnector(ctx, cfg, "oracle", u.String(), PlaceholderForDialect(DialectOracle))
}
